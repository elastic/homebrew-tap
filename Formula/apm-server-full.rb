class ApmServerFull < Formula
  ...
  url "https://staging.elastic.co/7.5.2-37ec0a99/downloads/apm-server/apm-server-7.5.2-darwin-x86_64.tar.gz?tap=elastic/homebrew-tap"
  version "7.5.2"
  sha256 "903824272038836e3f09733bf2da1f7b8f0a2f26725eab9080b66a1bec653ec3"
