class LogstashFull < Formula
  ...
  url "https://artifacts.elastic.co/downloads/logstash/logstash-7.8.0.tar.gz?tap=elastic/homebrew-tap"
  version "7.8.0"
  sha256 "9fecc07a8af8e9ced9f15b15cdf3e5cc0d2851fafce8510aa25d5e2c1f89c8a5"
  depends_on :java => "1.8"
