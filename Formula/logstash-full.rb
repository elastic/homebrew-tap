class LogstashFull < Formula
  ...
  url "https://artifacts.elastic.co/downloads/logstash/logstash-7.6.2.tar.gz?tap=elastic/homebrew-tap"
  version "7.6.2"
  sha256 "2bf5cb1bbb634552589f8676ffd4edb1e5d7338b91e08330193d160fe60dc868"
  depends_on :java => "1.8"
