class LogstashFull < Formula
  ...
  url "https://artifacts.elastic.co/downloads/logstash/logstash-7.2.0.tar.gz?tap=elastic/homebrew-tap"
  version "7.2.0"
  sha256 "ef1ea1cbe9924ae3b61fabdca5ab5af60f8740b87050e13d7f312139b23cd732"
  depends_on :java => "1.8"
