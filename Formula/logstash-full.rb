class LogstashFull < Formula
  ...
  url "https://artifacts.elastic.co/downloads/logstash/logstash-7.9.3.tar.gz?tap=elastic/homebrew-tap"
  version "7.9.3"
  sha256 "60cd7bfcbaac30b1f5e58669fb4a6a6c4533980702529230593ee8f8c24dd501"
  depends_on :java => "1.8"
