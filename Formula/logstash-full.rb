class LogstashFull < Formula
  ...
  url "https://artifacts.elastic.co/downloads/logstash/logstash-7.9.0.tar.gz?tap=elastic/homebrew-tap"
  version "7.9.0"
  sha256 "6492f9b040cd909ba307532bc5afcefc3b4305e912ef50e8fa8ee9fcc5aa035f"
  depends_on :java => "1.8"
