class LogstashFull < Formula
  ...
  url "https://artifacts.elastic.co/downloads/logstash/logstash-7.9.2.tar.gz?tap=elastic/homebrew-tap"
  version "7.9.2"
  sha256 "7c305159deb16fa1117f6e79fc936e7d61c44c1b4e633078fe5d750d8e44c9c3"
  depends_on :java => "1.8"
