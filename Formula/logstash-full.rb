class LogstashFull < Formula
  ...
  url "https://artifacts.elastic.co/downloads/logstash/logstash-7.9.1.tar.gz?tap=elastic/homebrew-tap"
  version "7.9.1"
  sha256 "b039a1b7a53ba79fdc7d40205dfe50c37d49850eb2d691e58883e11ccd95a8a6"
  depends_on :java => "1.8"
