class LogstashFull < Formula
  ...
  url "https://artifacts.elastic.co/downloads/logstash/logstash-7.4.1.tar.gz?tap=elastic/homebrew-tap"
  version "7.4.1"
  sha256 "57864fbb73dbc75828ecf70c7d46fd6c794d2d625259b9aada72f1ffdd1258d4"
  depends_on :java => "1.8"
